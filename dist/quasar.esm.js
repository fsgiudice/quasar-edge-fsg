...
var RowSelection = {
  ...
  methods: {
    ...
    rowsSelectAll: function rowsSelectAll () {
      ...
      this.rowSelection = this.rows.map(function () { return true; });
    },
